<?= $this->Html->script('jquery.bracket') ?>
<?= $this->Html->script('jquery.json-2.3.min') ?>
<?= $this->Html->script('brackets-rd') ?>
<?= $this->Html->css('jquery.bracket') ?>
...
<script type="text/javascript">var autoCompleteData = '<?= $autoCompleteData ?>'; </script>
<?php pr($autoCompleteData); ?>
